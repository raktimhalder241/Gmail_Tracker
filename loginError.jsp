...
<body style="background-color: grey;">
	...
	<table style="width : 100%; height : 5%; text-align: center; background-color: red;">
		<tr>
			...
			<td style="width: 40%;">Log-in Error</td>
	...
	<table style="width : 100%; height : 80%; background-color: grey;">
		<tr>
			...
			<td style="width: 50%; padding-top: 10px;">
				...
				Enter both email ID and password to Log-in.
				<br>
				In addition Enter App Specific Password while Registration.
				<br><br>
				
				<input type="button" value="go back"  style="width: 40%;" onclick="window.history.back();">
